...
**docs**
  * [Estructura de Directorios](./docs/index.md)
  ...
  * **formación**
    ...
    * **oposiciones**
      ...
      * **Constitución**
        * [constitución española.md](./docs/formación/oposiciones/Constitución/constitución española.md)

      * **DGA**
        * [ANEXO II](./docs/formación/oposiciones/DGA/Temas.md)

      * **ayuntamiento**
        * [TÉCNICA/O AUXILIAR INFORMATICO.](./docs/formación/oposiciones/ayuntamiento/TAI_ayuntamiento_temario.md)

  * **hw**
    * [MAC de dispositivos.md](./docs/hw/MAC de dispositivos.md)
    * [Instalación de Smartcards](./docs/hw/Smartcards.md)
    * [discos_duros.md](./docs/hw/discos_duros.md)
    * [Howto: Mustek 1200 UB Plus USB Scanner Install](./docs/hw/scanner.md)
  ...
  * **multimedia**
    * [FreeCAD](./docs/multimedia/FreeCAD.md)
    * [Jellyfin](./docs/multimedia/jellyfin.md)
    * [JHead](./docs/multimedia/jhead.md)
    * [Comandos varios sobre multimedia](./docs/multimedia/multimediaCommands.md)
    * [Aplicaciones multimedia](./docs/multimedia/multimediaVarios.md)
    * [Convertir texto a audio en Gentoo](./docs/multimedia/text2mp3.md)

    * **Blender**
      * [Geometry Nodes](./docs/multimedia/Blender/Geometry Nodes.md)
      * [Blender](./docs/multimedia/Blender/blender.md)
      * [Enlaces para visualizar](./docs/multimedia/Blender/blender_TODO.md)
      * [Python para Blender](./docs/multimedia/Blender/blender_python.md)
  ...
  * **programacion**
    ...
    * [free-programming-books-es.md](./docs/programacion/free-programming-books-es.md)
    * [Documentación con mkdocs](./docs/programacion/mkdocs.md)
    * [Crear un bot de Telegram con php](./docs/programacion/telegramBot.md)
    * [Enlaces](./docs/programacion/varios.md)
    * [Enlaces varios de programación](./docs/programacion/variosProgramación.md)

    * **MySQL**
      * [MySQL_varios.md](./docs/programacion/MySQL/MySQL_varios.md)
      * [Programar copias de seguridad para MySQL y MariaDB](./docs/programacion/MySQL/backupMySQL.md)

    * **bash**
      * [Uso de date](./docs/programacion/bash/date.md)
      * [strings.md](./docs/programacion/bash/strings.md)
      * [Variables en Bash](./docs/programacion/bash/variables.md)
      * [varios.md](./docs/programacion/bash/varios.md)

    * **css**
      * [Animaciones en CSS3](./docs/programacion/css/animacionesCss3.md)
      * [Bootstrap Codeschool](./docs/programacion/css/bootstrap_codeschool.md)
      * [SASS en Codeacademy](./docs/programacion/css/sass.md)
    ...
    * **java**
      * [Spring Framework 5](./docs/programacion/java/Spring.md)

    * **javascript**
      * [Airbnb JavaScript Style Guide() {](./docs/programacion/javascript/Airbnb_JavaScript_Style_Guide.md)
      * [Angular.md](./docs/programacion/javascript/Angular.md)
      * [Angular4](./docs/programacion/javascript/Angular4.md)
      * [Learn AngularJS](./docs/programacion/javascript/angularjs_codeacademy.md)
      * [Novedades en ES6](./docs/programacion/javascript/es6.md)
      * [JQuery and Ajax](./docs/programacion/javascript/jquery _ajax_codeacademy.md)
      * [Jquery](./docs/programacion/javascript/jquery.md)
      * [Codeacademy JQuery](./docs/programacion/javascript/jquery_codeacademy.md)
      * [JQuery Codeschool](./docs/programacion/javascript/jquery_codeschool.md)
      * [jQuery: The Return Flight](./docs/programacion/javascript/jquery_codeschool_2.md)
      * [Typescript](./docs/programacion/javascript/typescript.md)

      * **ejemplos**
        * [Ejemplos de Javascript](./docs/programacion/javascript/ejemplos/ejemplos1.md)
    ...
    * **php**
      ...
      * **Symfony3**
        * [Curso de Symfony 3 de Victor Robles](./docs/programacion/php/Symfony3/CursoVictorRobles.md)
    ...
    * **rust**
      * [Enlaces de interés sobre Rust](./docs/programacion/rust/rust_Varios.md)
  ...
  * **redes**
    * [Conectar un dominio propio a una ip dinámica](./docs/redes/Cloudflare.md)
    * [GlusterFS](./docs/redes/GlusterFS.md)
    * [awensome tunneling.md](./docs/redes/awensome tunneling.md)
    * [Tailscale autoalojado: Headscale](./docs/redes/headscale.md)
    * [Configuración de IP Dinámica con Freenom.com y ClouDNS](./docs/redes/ipdinamica+freenom+clouddns.md)
    * [NGROK - Exponé tu app con SSL GRATIS! (2022-09-07)](./docs/redes/ngrok.md)
    * [Samba](./docs/redes/samba.md)
    * [Streaming local con Sunshine + Moonlight](./docs/redes/sunshine-moonlight-arch.md)
    ...
    * **AWS**
      * [Amazon Web Services (Miguel Arranz)](./docs/redes/AWS/aws.md)
    ...
    * **ssh**
      ...
      * [Tunel ssh](./docs/redes/ssh/sshTunel.md)
  ...
  * **sistema**
    ...
    * [Minio](./docs/sistema/minio.md)
    * [How To Mount A USB Flash Disk On The Raspberry Pi](./docs/sistema/mountDevice.md)
    * [Polybar](./docs/sistema/polybar.md)
    * [Screen](./docs/sistema/screen.md)
    ...
    * **Raspberry**
      ...
      * [Links y utilidades varias para la Raspberry pi](./docs/sistema/Raspberry/variosRaspberry.md)

    * **Virtualizacion**

      * **Docker**
        * [Docker](./docs/sistema/Virtualizacion/Docker/Docker.md)
        * [Uso del API de Docker](./docs/sistema/Virtualizacion/Docker/DockerAPI.md)
        * [Curso Docker de Udemy (Ricardo Andre Gonzalez Gomez)](./docs/sistema/Virtualizacion/Docker/cursoDockerUdemy.md)
        * [Orquestación con Docker-compose](./docs/sistema/Virtualizacion/Docker/docker-compose.md)
        * [Docker](./docs/sistema/Virtualizacion/Docker/dockerEspañol.md)
        * [dockerUtils.md](./docs/sistema/Virtualizacion/Docker/dockerUtils.md)
        * [Aceleración gráfica en Docker](./docs/sistema/Virtualizacion/Docker/driDocker.md)
        * [Etiquetas y argumentos](./docs/sistema/Virtualizacion/Docker/etiquetas_y_argumentos.md)
        * [Kubernentes](./docs/sistema/Virtualizacion/Docker/kubernetes.md)
    ...
    * **archLinux**
      ...
      * [installArchLinuxUsb.md](./docs/sistema/archLinux/installArchLinuxUsb.md)
      * [Problemas con arch](./docs/sistema/archLinux/problemas.md)
      * [varios.md](./docs/sistema/archLinux/varios.md)

    * **backups**
      * [Copias de seguridad con Borg backup](./docs/sistema/backups/backupBorg.md)
      * [Copias de seguridad con Duplicity](./docs/sistema/backups/backupDuplicity.md)
      * [Copia de seguridad del sistema con PartClone](./docs/sistema/backups/backupPartClone.md)
      * [Copias de seguridad con Restic](./docs/sistema/backups/backupRestic.md)
      * [backupRsync.md](./docs/sistema/backups/backupRsync.md)
      * [raspberryBackup.md](./docs/sistema/backups/raspberryBackup.md)

      * **dotfiles**
        * [Cómo administrar ficheros de configuración](./docs/sistema/backups/dotfiles/dotfiles.md)

    * **bash**
      * [bash-guide.md](./docs/sistema/bash/bash-guide.md)
      * [Modificación de los colores del comando ls](./docs/sistema/bash/lsColors.md)
      * [variosBash.md](./docs/sistema/bash/variosBash.md)
  ...
  * **varios**
    ...
    * [blues.md](./docs/varios/blues.md)
    * [Cursos varios](./docs/varios/cursos.md)
    * [Enaces varios](./docs/varios/enlaces.md)
    * [Enlaces pendientes](./docs/varios/enlacespendientes.md)
    * [regalos.md](./docs/varios/regalos.md)
    * [selfhosted.md](./docs/varios/selfhosted.md)
    * [Trabajo](./docs/varios/trabajo.md)
    ...
    * **lovehacks**
      ...
      * [Enlaces interesantes](./docs/varios/lovehacks/enlaces.md)
